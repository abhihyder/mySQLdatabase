...
?>
  <span>Update Teacher Details:-</span>
...
<?php
   ...
   <span>Insert Teacher Details:-</span>
  <form action="" method="post">
    <table>
      <tr>
          <td>Name: </td>
...
<section class="mainright">
  ...
  <span style="float:right"><a href="index_student.php">Students data</a> || <a href="index_teacher.php">Teachers data</a></span>
    ...
    ?>
      ...
      <td>
      <?php echo "<a href='index_teacher.php?action=update&id=".$value['id']."'>Edit</a>";?> ||
      <?php echo "<a href='index_teacher.php?action=delete&id=".$value['id']."' onclick='return confirm(\"Are you sure you want to delete this data?\")'>Delete</a>";?>
      </td>
  </tr>
<?php } ?>
